...
.report-table th { background: rgba(255,255,255,0.03); font-size: 12px; color: #6b7280; font-weight: 600; text-transform: uppercase; }
...
.badge-paid { background: rgba(16,185,129,0.15); color: #10b981; padding: 2px 8px; border-radius: 12px; font-size: 11px; font-weight: 600; }
.badge-abandoned { background: rgba(245,158,11,0.15); color: #f59e0b; padding: 2px 8px; border-radius: 12px; font-size: 11px; font-weight: 600; }
</style>