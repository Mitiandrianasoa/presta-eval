...
.report-table th, .report-table td { border: 1px solid rgba(255,255,255,0.06); padding: 10px 12px; text-align: left; font-size: 14px; }
.report-table th { background: rgba(255,255,255,0.03); color: #6b7280; font-weight: 600; font-size: 13px; }
.report-table td { color: #a0a0b8; }
.center { text-align: center; }
.success td { background: rgba(16,185,129,0.06); }
.error td { background: rgba(239,68,68,0.06); }
.rolled_back td { background: rgba(245,158,11,0.06); color: #f59e0b; }
.badge { background: rgba(249,115,22,0.15); color: #f97316; padding: 2px 6px; border-radius: 12px; font-size: 11px; font-weight: 600; }
.error .badge { background: rgba(239,68,68,0.15); color: #ef4444; }
.success .badge { background: rgba(16,185,129,0.15); color: #10b981; }
.rolled_back .badge { background: rgba(245,158,11,0.15); color: #f59e0b; }
.txt-success { color: #10b981; font-weight: bold; }
.txt-error { color: #ef4444; font-weight: bold; }
.txt-rollback { color: #f59e0b; font-style: italic; }
