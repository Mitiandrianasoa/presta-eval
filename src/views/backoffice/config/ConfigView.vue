...
.config-section { background: #161b22; border: 1px solid #30363d; border-radius: 10px; padding: 1.75rem; margin-bottom: 1.5rem; }
...
.config-row { display: flex; align-items: center; justify-content: space-between; padding: 0.875rem 0; border-bottom: 1px solid #21262d; gap: 2rem; }
.config-row:last-child { border-bottom: none; }
.config-label { font-size: 0.875rem; font-weight: 600; color: #e6edf3; }
.config-desc { font-size: 0.75rem; color: #7d8590; margin-top: 0.2rem; }
...
.config-input:focus, .config-select:focus { outline: none; border-color: #388bfd; }
.config-select option { background: #161b22; }
.toggle-btn { position: relative; width: 44px; height: 24px; background: #21262d; border: 1px solid #30363d; border-radius: 12px; cursor: pointer; transition: background 0.2s; }
.toggle-btn.active { background: #388bfd; border-color: #388bfd; }
.toggle-btn::after { content: ''; position: absolute; width: 16px; height: 16px; background: white; border-radius: 50%; top: 3px; left: 3px; transition: left 0.2s; }
.toggle-btn.active::after { left: 21px; }
.save-btn { padding: 0.65rem 2rem; background: #388bfd; border: none; border-radius: 7px; color: white; font-weight: 600; font-size: 0.875rem; cursor: pointer; transition: background 0.2s; }
.save-btn:hover { background: #1f6feb; }
